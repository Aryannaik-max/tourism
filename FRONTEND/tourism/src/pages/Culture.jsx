...
const Culture = () => {
  return (
    <section className="bg-gray-100 py-16 px-4 font-sans">
      ...
      {/* Main Hero Section */}
      <div className="max-w-7xl mx-auto rounded-xl overflow-hidden shadow-lg mb-16">
        <div className="relative w-full h-80">
          ...
          />
          <div className="absolute inset-0 bg-[#152A4C] bg-opacity-70 flex items-center justify-center p-4">
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row-reverse items-center gap-12 mb-16">
        <div className="w-full md:w-1/2">
          <h2 className="text-3xl font-bold text-[#152A4C] mb-4">Living Rhythms</h2>
          <p className="text-gray-700 leading-relaxed text-lg">
      ...
      <div className="max-w-7xl mx-auto text-center mb-16">
        <h2 className="text-3xl md:text-4xl font-bold text-[#152A4C] mb-8">Folk Dances of Jharkhand</h2>
        ...
        {/* Paika Dance */}
        <div className="bg-white p-8 rounded-xl shadow-lg mb-8 flex flex-col md:flex-row items-center gap-8">
          <div className="w-full md:w-2/3 text-left">
            <h3 className="text-2xl font-bold text-[#152A4C] mb-2">Paika</h3>
        ...
        {/* Chhau Dance */}
        <div className="bg-white p-8 rounded-xl shadow-lg mb-8 flex flex-col md:flex-row-reverse items-center gap-8">
          <div className="w-full md:w-2/3 text-left">
            <h3 className="text-2xl font-bold text-[#152A4C] mb-2">Chhau</h3>
            <p className="text-gray-700 leading-relaxed">
        ...
        <div className="bg-white p-8 rounded-xl shadow-lg mb-8 flex flex-col md:flex-row items-center gap-8">
          <div className="w-full md:w-2/3 text-left">
            <h3 className="text-2xl font-bold text-[#152A4C] mb-2">Santhal</h3>
            <p className="text-gray-700 leading-relaxed">
        ...
        <div className="bg-white p-8 rounded-xl shadow-lg mb-8 flex flex-col md:flex-row-reverse items-center gap-8">
          <div className="w-full md:w-2/3 text-left">
            <h3 className="text-2xl font-bold text-[#152A4C] mb-2">Karma</h3>
            <p className="text-gray-700 leading-relaxed">
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12 mb-16">
        <div className="w-full md:w-1/2">
          <h2 className="text-3xl font-bold text-[#152A4C] mb-4">Art, Craft and Living</h2>
          <p className="text-gray-700 leading-relaxed text-lg">
      ...
      <div className="max-w-7xl mx-auto">
        <h2 className="text-3xl md:text-4xl font-bold text-[#152A4C] text-center mb-8">Distinctive Traditions</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* Tradition blocks */}
          <div className="bg-white p-6 rounded-xl shadow-lg">
            <h3 className="text-xl font-bold text-[#152A4C] mb-2">Oraon comb-cut paintings</h3>
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg">
            <h3 className="text-xl font-bold text-[#152A4C] mb-2">Ganju</h3>
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg">
            <h3 className="text-xl font-bold text-[#152A4C] mb-2">Prajapati, Rana & Teli</h3>
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg">
            <h3 className="text-xl font-bold text-[#152A4C] mb-2">Kurmi</h3>
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg">
            <h3 className="text-xl font-bold text-[#152A4C] mb-2">Mundas</h3>
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg">
            <h3 className="text-xl font-bold text-[#152A4C] mb-2">Ghatwals</h3>
            <p className="text-gray-700">Ghatwals use glyptic paintings of animals on their forest dwellings.</p>
          </div>
          <div className="bg-white p-6 rounded-xl shadow-lg">
            <h3 className="text-xl font-bold text-[#152A4C] mb-2">Turi</h3>
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg">
            <h3 className="text-xl font-bold text-[#152A4C] mb-2">Birhor & Bhuiya</h3>
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg">
            <h3 className="text-xl font-bold text-[#152A4C] mb-2">Manjhi Santhal</h3>
